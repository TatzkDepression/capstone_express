...
(1, 1, 1, '2024-11-08', 'ngon');
INSERT INTO `binh_luan` (`binh_luan_id`, `nguoi_dung_id`, `hinh_id`, `ngay_binh_luan`, `noi_dung`) VALUES
(2, 2, 2, '2024-09-27', 'bình thường');
INSERT INTO `binh_luan` (`binh_luan_id`, `nguoi_dung_id`, `hinh_id`, `ngay_binh_luan`, `noi_dung`) VALUES
(3, 3, 3, '2024-07-26', 'rất tuyệt');
INSERT INTO `binh_luan` (`binh_luan_id`, `nguoi_dung_id`, `hinh_id`, `ngay_binh_luan`, `noi_dung`) VALUES
(4, 4, 4, '2024-04-27', 'không ngon'),
(5, 5, 5, '2024-08-23', 'vừa ăn'),
(6, 6, 6, '2024-04-23', 'hơi nhạt'),
(7, 7, 7, '2024-05-12', 'mặn'),
(8, 8, 8, '2024-08-01', 'nhạt'),
(9, 9, 9, '2024-12-11', 'cay'),
(10, 10, 10, '2024-05-21', 'nguội');
